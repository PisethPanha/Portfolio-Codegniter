        ...
        <div class="min-h-screen bg-background text-foreground">
            <section class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16">
                <div class="mb-12">
                    <p class="text-accent text-sm font-semibold uppercase tracking-wider mb-3">Get In Touch</p>
                    <h1 class="text-4xl md:text-5xl font-bold text-foreground mb-6">Contact Me</h1>
                    <p class="text-lg text-muted-foreground max-w-3xl leading-relaxed">Have a project in mind or want to discuss collaboration opportunities? I &#x27;d love to hear from you. Feel free to reach out using the form below or through any of my social channels.</p>
                </div>
            </section>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-12">
                    <div class="space-y-6">
                        <div class="bg-card rounded-lg border border-border p-6">
                            <div class="flex items-start gap-4">
                                <div class="p-3 rounded-lg bg-accent/10">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-mail h-5 w-5 text-accent">
                        ...
                        <div class="bg-card rounded-lg border border-border p-6">
                            <div class="flex items-start gap-4">
                                <div class="p-3 rounded-lg bg-accent/10">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-phone h-5 w-5 text-accent">
                        ...
                        <div class="bg-card rounded-lg border border-border p-6">
                            <div class="flex items-start gap-4">
                                <div class="p-3 rounded-lg bg-accent/10">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-map-pin h-5 w-5 text-accent">
                        ...
                        <div class="bg-card rounded-lg border border-border p-6">
                            ...
                            <div class="flex gap-3">
                                <a href="https://github.com" target="_blank" rel="noopener noreferrer" class="p-2.5 rounded-lg bg-accent/10 text-accent hover:bg-accent hover:text-accent-foreground transition-colors" aria-label="GitHub">
                                ...
                                <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" class="p-2.5 rounded-lg bg-accent/10 text-accent hover:bg-accent hover:text-accent-foreground transition-colors" aria-label="LinkedIn">
                                ...
                                <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" class="p-2.5 rounded-lg bg-accent/10 text-accent hover:bg-accent hover:text-accent-foreground transition-colors" aria-label="Twitter">
                                ...
                                <a href="mailto:alex@example.com" target="_blank" rel="noopener noreferrer" class="p-2.5 rounded-lg bg-accent/10 text-accent hover:bg-accent hover:text-accent-foreground transition-colors" aria-label="Email">
