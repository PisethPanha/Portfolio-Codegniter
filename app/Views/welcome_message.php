            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                <div class="space-y-6">
                    <div class="space-y-3">
                        ...
                        <h1 class="text-4xl md:text-5xl lg:text-6xl font-bold text-foreground">YORN PISETHPANHA</h1>
                        <h2 class="text-xl md:text-2xl text-accent font-semibold">Full Stack Developer</h2>
                    </div>
                    <p class="text-lg text-muted-foreground max-w-md leading-relaxed">Building beautiful, scalable digital experiences</p>
                ...
                <div class="hidden md:flex items-center justify-center">
                    <div class="relative w-full aspect-square max-w-sm">
                        ...
                        <div class="absolute inset-6 bg-gradient-to-tr from-accent/30 to-secondary/10 rounded-2xl flex items-center justify-center"><img src="https://res.cloudinary.com/dbylpzlji/image/upload/v1769053807/photo_2024-06-21_14-10-39_dblujm.jpg" class="rounded-2xl hover:scale-[1.1] duration-300" alt="" /></div>
                    </div>
                </div>
            </div>
            <div class="grid grid-cols-3 gap-6 mt-20 pt-12 border-t border-border">
                <div class="text-center">
                    <p class="text-3xl font-bold text-accent">50+</p>
            ...
            <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div class="group rounded-lg border border-border bg-background p-6 hover:border-accent/50 transition-all hover:shadow-lg">
                        <div class="aspect-video rounded-md bg-gradient-to-br from-accent/20 to-secondary/20 mb-4 flex items-center justify-center"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-code-xml h-8 w-8 text-accent/50">
                                <path d="m18 16 4-4-4-4"></path>
                                <path d="m6 8-4 4 4 4"></path>
                                <path d="m14.5 4-5 16"></path>
                            </svg></div>
                        <h3
                            class="font-semibold text-foreground mb-2">Project Title</h3>
                        <p class="text-sm text-muted-foreground mb-4">A brief description of the project and the technologies used.</p><a class="text-accent text-sm font-medium hover:underline" href="/projects">Learn more →</a>
                    </div>
                    <div class="group rounded-lg border border-border bg-background p-6 hover:border-accent/50 transition-all hover:shadow-lg">
                        <div class="aspect-video rounded-md bg-gradient-to-br from-accent/20 to-secondary/20 mb-4 flex items-center justify-center"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-code-xml h-8 w-8 text-accent/50">
                                <path d="m18 16 4-4-4-4"></path>
